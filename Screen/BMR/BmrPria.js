...
export default class BmrPria extends Component {
    ...
    cekDataBMR() {
        AsyncStorage.getItem('BmrLaki', (err, item) => {
            if (item) {
    ...
    componentDidMount() {
        this.getDataBMR();
        this.cekDataBMR();
        //AsyncStorage.removeItem('BmrLaki')
    }
    ...
    hitungKalori() {
        ...
        //console.log(selectedPagi.Kalori);

        // (587 + (9.6 * this.state.alas) + 
        // (1.8 * this.state.tinggi) - (4.7 * this.state.umur)) - 
        // (this.state.kalori1)

        // (66 + (13.7 * this.state.alas) + 
        // (5 * this.state.tinggi) - (6.8 * this.state.umur))
        let hasil = (66 + (13.7 * alas) + (5 * tinggi) - (6.8 * umur)) - parseInt(selectedPagi.Kalori) - parseInt(selectedSiang.Kalori) - parseInt(selectedMalam.Kalori);
        ...
        AsyncStorage.setItem('BmrLaki', JSON.stringify(BmrLaki));
    }
