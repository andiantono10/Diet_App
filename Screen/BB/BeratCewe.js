...
export default class BeratCewe extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alas: 0,
            ...
            <ImageBackground source={require('../../assets/bbwanita.png')} style={{ flex: 1 }} resizeMode='cover'>
                ...
                <View style={{ backgroundColor: '#2196f3' }}>
                    <Text style={{ padding: 10, fontSize: 20, color: 'white', textAlign: 'center' }} >
                        Hitung Berat Badan Ideal Wanita
          </Text>
                </View>
                ...
                <View style={{ margin: 20, padding: 10, backgroundColor: '#e3f2fd', opacity: 0.8 }}>
                    ...
                    <Button
                        onPress={() => this.setState({
                            luas: ((this.state.tinggi - 100) - (0.15 * (this.state.tinggi - 100)))
                        })}
                        title="Hitung"
